 ...
 */
public class stage7 extends javax.swing.JFrame {

    /**
     * Creates new form stage7
     */
    String nama;

    public stage7(String data) {
        initComponents();
        user.setText(data);
        nama = data;
        jawaban.grabFocus();
    ...
    private void initComponents() {
        ...
        layout.setIcon(new javax.swing.ImageIcon(getClass().getResource("/7.png"))); // NOI18N
    ...
    private void cekMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_cekMouseClicked
        // TODO add your handling code here:
        stage8 obj = new stage8(nama);
        if (jawaban.getText().equals("")) {
        } else {
            if (i >= 0) {
                if (jawaban.getText().equals("lilin lilin kecil")||jawaban.getText().equals("LILIN LILIN KECIL")) {
                    this.setVisible(false);
                    obj.setVisible(true);
                } else if (i == 0) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(stage7.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
