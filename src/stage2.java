...
public class stage2 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        layout.setIcon(new javax.swing.ImageIcon(getClass().getResource("/2.png"))); // NOI18N
    ...
    private void homeComponentHidden(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_homeComponentHidden
        // TODO add your handling code here:
    }//GEN-LAST:event_homeComponentHidden

    int i = 2;
    private void cekMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_cekMouseClicked
        // TODO add your handling code here:
        stage3 obj = new stage3(nama);
        if (jawaban.getText().equals("")) {
        } else {
            if (i >= 0) {
                if (jawaban.getText().equals("monokrom")||jawaban.getText().equals("MONOKROM")) {
                    this.setVisible(false);
                    obj.setVisible(true);
                } else if (i == 0) {
