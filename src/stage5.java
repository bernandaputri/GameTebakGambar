...
public class stage5 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        layout.setIcon(new javax.swing.ImageIcon(getClass().getResource("/5.png"))); // NOI18N
    ...
    private void cekMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_cekMouseClicked
        // TODO add your handling code here:
        stage6 obj = new stage6(nama);
        if (jawaban.getText().equals("")) {
        } else {
            if (i >= 0) {
                if (jawaban.getText().equals("MENANTI SEBUAH JAWABAN")||jawaban.getText().equals("menanti sebuah jawaban")) {
                    this.setVisible(false);
                    obj.setVisible(true);
                } else if (i == 0) {
