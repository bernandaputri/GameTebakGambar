 ...
 */
public class stage10 extends javax.swing.JFrame {

    /**
     * Creates new form stage10
     */
    String nama;

    public stage10(String data) {
        initComponents();
        user.setText(data);
        nama = data;
        jawaban.grabFocus();
    ...
    private void initComponents() {
        ...
        layout.setIcon(new javax.swing.ImageIcon(getClass().getResource("/10.png"))); // NOI18N
    ...
    private void cekMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_cekMouseClicked
        // TODO add your handling code here:
        finish obj = new finish(nama);
        if (jawaban.getText().equals("")) {
        } else {
            if (i >= 0) {
                if (jawaban.getText().equals("TIKUS-TIKUS KANTOR")||jawaban.getText().equals("TIKUS TIKUS KANTOR")||jawaban.getText().equals("tikus-tikus kantor")||jawaban.getText().equals("tikus tikus kantor")) {
                    this.setVisible(false);
                    obj.setVisible(true);
                } else if (i == 0) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(stage10.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
