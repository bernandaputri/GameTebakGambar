...
public class stage4 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        layout.setIcon(new javax.swing.ImageIcon(getClass().getResource("/4.png"))); // NOI18N
    ...
    private void cekMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_cekMouseClicked
        // TODO add your handling code here:
        stage5 obj = new stage5(nama);
        if (jawaban.getText().equals("")) {
        } else {
            if (i >= 0) {
                if (jawaban.getText().equals("tari ubur-ubur")||jawaban.getText().equals("tari ubur ubur")||jawaban.getText().equals("TARI UBUR-UBUR")||jawaban.getText().equals("TARI UBUR UBUR")) {
                    this.setVisible(false);
                    obj.setVisible(true);
                } else if (i == 0) {
