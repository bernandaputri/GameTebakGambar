...
//PlaceHolder p;
    ...
    private void initComponents() {
        ...
        layout.setIcon(new javax.swing.ImageIcon(getClass().getResource("/1.png"))); // NOI18N
    ...
    private void cekMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_cekMouseClicked
        // TODO add your handling code here:
        stage2 obj = new stage2(nama);
        if (jawaban.getText().equals("")) {
        } else {
            if (i >= 0) {
                if (jawaban.getText().equals("tenda biru")||jawaban.getText().equals("TENDA BIRU")) {
                    this.setVisible(false);
                    obj.setVisible(true);
                } else if (i == 0) {
