 ...
 */
public class stage9 extends javax.swing.JFrame {

    /**
     * Creates new form stage9
     */
    String nama;

    public stage9(String data) {
        initComponents();
        user.setText(data);
        nama = data;
        jawaban.grabFocus();
    ...
    private void initComponents() {
        ...
        layout.setIcon(new javax.swing.ImageIcon(getClass().getResource("/9.png"))); // NOI18N
    ...
    private void cekMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_cekMouseClicked
        // TODO add your handling code here:
        stage10 obj = new stage10(nama);
        if (jawaban.getText().equals("")) {
        } else {
            if (i >= 0) {
                if (jawaban.getText().equals("cinta satu malam")||jawaban.getText().equals("CINTA SATU MALAM")) {
                    this.setVisible(false);
                    obj.setVisible(true);
                } else if (i == 0) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(stage9.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
