 ...
 */
public class stage8 extends javax.swing.JFrame {

    /**
     * Creates new form stage8
     */
    String nama;

    public stage8(String data) {
        initComponents();
        user.setText(data);
        nama = data;
        jawaban.grabFocus();
    ...
    private void initComponents() {
        ...
        layout.setIcon(new javax.swing.ImageIcon(getClass().getResource("/8.png"))); // NOI18N
    ...
    private void cekMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_cekMouseClicked
        // TODO add your handling code here:
        stage9 obj = new stage9(nama);
        if (jawaban.getText().equals("")) {
        } else {
            if (i >= 0) {
                if (jawaban.getText().equals("mbah dukun")||jawaban.getText().equals("MBAH DUKUN")) {
                    this.setVisible(false);
                    obj.setVisible(true);
                } else if (i == 0) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(stage8.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
